...
def get_xy_fd(hash_flag=False):
    feature_dim_dict = {"sparse": [SingleFeat('item', 3 + 1, hash_flag), SingleFeat('item_gender', 2 + 1, hash_flag)],
    ...
    feature_dict = {'item': iid, 'item_gender': igender,
...
if __name__ == "__main__":
    ...
    print(len(behavior_feature_list))


    model = DSIN(feature_dim_dict, behavior_feature_list, sess_max_count=1, sess_len_max=4, embedding_size=4,
